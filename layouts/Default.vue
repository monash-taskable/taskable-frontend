    ...
    <header>
      ...
      <nav>
          ...
          <div class="dropdown-content noti-menu">
            ...
            <NotificationPopupEntry
              ...
              <NotificationPopupEntry 
                ...
                icon="fluent:animal-cat-20-regular"
                :timestamp="new Date(Date.now().toString())"
                :tabindex="1003.3"/>
          </div>
        </TitleDropdown>
        ...
        <IconButton
          ...
          caption="John Smith"/>
        <TitleDropdown 
          :id="_userMenuId" :button="_userMenu" 
          click-away :show="_userMenuRef" @hide="_hideUserMenu">
          <template #tab>
            <IconButton
              :tabindex="1005.1"
              @click="_hideUserMenu"
...
div.dropdown-content {
  ...
  &.user-menu { background: var(--layer-background); }
  &.noti-menu { width: 25rem; }
}
...
.noti-menu {
  .noti-label {
    ...
    &:nth-child(1) { padding-top: $space-medium; }
  }
}
</style>