...
import { modifyProjectMemberRole } from '~/scripts/ProjectClassesFetches';
...
const { currRole, members, projId, selfRole } = props.context.payload;
...
const onRoleChange = async (role: OwnershipRole) => {
  ...
  modifyProjectMemberRole(projId, members, role);
